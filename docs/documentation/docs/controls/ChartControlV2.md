# ChartControl control V2

This control makes it easy to integrate [Chart.js V.4](https://www.chartjs.org) charts into your web parts. It offers most of the functionality available with Chart.js.
...
Here is an example of the control in action in the test controls web part showing multiple charts:

![ChartControl V2 in test web part](<../assets/Chart Control V2 test controls.png>)
...
```TypeScript
import { ChartControl, ChartTypeV2 } from '@pnp/spfx-controls-react/lib/ChartControlV2';
```
...
![Bar chart V2](<../assets/Chart Control V2 bar chart sample.png>)
