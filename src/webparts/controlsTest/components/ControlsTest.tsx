    ...
    return (
      <div className={styles.controlsTest}>
        <div className="ms-font-m">
          ...
          <DynamicForm context={this.props.context} listId={"F2AECDE9-2D98-49F2-99ED-B0A3EB107141"} onCancelled={() => { console.log('Cancelled'); }} onSubmitted={async (listItem) => { let itemdata = await listItem.get(); console.log(itemdata["ID"]); }}></DynamicForm>
        </div>
        <div className="ms-font-m">
          {/* Change the list Id and list item id before you start to test this control */}
