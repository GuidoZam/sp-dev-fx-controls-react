...
import { ChartType as ChartTypeV2 } from '../../../controls/chartControlV2/ChartControl.types';
...
const ChartControlV2 = React.lazy(() => import('../../../ChartControlV2').then(module => ({ default: module.ChartControlV2 })));
