...
define([], () => {
  return {
    ...
    TaxonomyPickerTermsNotFound:
      "De volgende geselecteerde term(en) is(en) niet gevonden in het termenarchief: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Probleem bij het verwijderen van het bestand: {0}, rede {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Probleem bij het laden van de bijlage, rede: {0}",
    ListItemAttachmentsconfirmDelete:
      "Ben je zeker dat je het bestand {0} wilt verwijderen?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "Het bestand {0} kon niet toegevoegd worden, rede: {1}",
    ...
    CantValidateValidationMessage:
      "We konden deze link niet verifiëren. Controleer de link en probeer het opnieuw.",
    ...
    CopyrightWarning:
      "U bent verantwoordelijk voor het respecteren van de rechten van anderen, waaronder het auteursrecht.",
    CreativeCommonsMessage:
      "Deze resultaten zijn gelabeld met Creative Commons-licenties. Controleer de licenties om ervoor te zorgen dat u voldoet.",
    DateFormat: "MM/DD/JJJJ uu: mm A",
    DocumentLabelTemplate:
      "{0}, document, gewijzigd {1}, bewerkt door {2}, privé",
    ...
    FolderLabelTemplate:
      "{0}, map, gewijzigd {1}, bewerkt door {2}, {3} items, privé",
    ...
    LinkFileInstructions:
      "Een koppeling naar een bestand in OneDrive voor bedrijven of SharePoint Online plakken",
    LinkHeader: "Via een koppeling",
    LinkImageInstructions:
      "Een koppeling naar een afbeelding in OneDrive voor bedrijven of SharePoint Online plakken",
    ListLayoutAriaLabel: "Bekijk opties. {0} {1}.",
    ListLayoutCompact: "Compacte weergave",
    ListLayoutCompactDescription:
      "Items en Details in een compacte lijst weergeven",
    ...
    NoExternalLinksValidationMessage:
      "We ondersteunen alleen het linken naar bestanden in uw eigen organisatie.",
    NoImageValidationMessage:
      "Dit is geen koppeling naar een bestandstype dat we ondersteunen. U alleen een koppeling maken naar een afbeelding.",
    NoRecentFiles: "Geen recente bestanden",
    NoRecentFilesDescription:
      "Probeer een bestand van je site te selecteren of upload het van je apparaat.",
    NoResultsBadEnglish:
      "Er is geen resultaat gevonden. Probeer de filteropties te wijzigen",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, gewijzigd {2}, bewerkt door {3}, {4}, {5}",
    OneDriveConfirmDialogBody:
      "Dit object is afkomstig van je OneDrive-site. Bestanden en mappen in OneDrive zijn privé tenzij je ze deelt. Heeft u dit bestand gedeeld met uw siteleden zodat ze het kunnen Cess?",
    OneDriveConfirmDialogTitle: "Gewoon controleren...",
    OneDriveEmptyFolderAlt: "Lege map",
    OneDriveEmptyFolderDescription:
      "Als u bestanden wilt toevoegen, gaat u naar OneDrive. U ook bestanden toevoegen aan deze map met behulp van de OneDrive-app voor uw computer.",
    ...
    OrgAssetsTabLabel:
      "Afbeeldingen en bestanden die door uw organisatie worden geleverd",
    ...
    SearchResultAriaLabel:
      "Druk op ENTER om de afbeeldingsbron in een nieuw tabblad te openen.",
    ...
    SizeUnit: ["Bytes", "Kb", "Mb", "Gb", "Tb", "PB", "Eb", "BV", "Yb"],
    SorryWebSearch:
      "Sorry, deze functie is niet geïmplementeerd in dit voorbeeld, omdat er een Bing API-sleutel vereist.",
    SortedAscending: "Gesorteerd op A tot Z",
    SortedDescending: "Gesorteerd Z naar A",
    TypeAriaLabel:
      "Kolom bewerkingen voor bestandstype, druk op om te sorteren op bestandstype",
    ...
    NewFolderIncorrectSymbolsError:
      'Voer een naam in die geen van deze tekens bevat: " * : < > ? /  |.',
    ...
    CollectionDataEmptyFields:
      "Er zijn geen velden opgegeven voor de verzamelingsgegevens.",
    ...
    MyTeamsMessageError:
      "Er is iets misgegaan tijdens het laden van uw teams, probeer het later of vernieuw de browser",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Er zijn validatiefouten, corrigeer deze voordat u opslaat.",
    ...
    MyTeamsMessageDontHaveTeams: "Je hebt geen teams",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Voer een term in die u wilt taggen",
