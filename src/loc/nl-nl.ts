...
define([], () => {
  return {
    ...
    "DynamicFormErrorUpdatingItem": "Fout bij het bijwerken van het item",
    "DynamicFormErrorAddingItem": "Fout bij het toevoegen van het item",
    "DynamicFormErrorReadingIDOfNewItem": "Fout bij het lezen van de ID van het nieuwe item",
    "DynamicFormErrorOnSubmit": "Fout bij het verzenden van het formulier",
    "DynamicFormErrorLoadingFieldsInformations": "Fout bij het laden van veldinformatie",
