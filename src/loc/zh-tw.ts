...
define([], () => {
  return {
    ...
    OneDriveConfirmDialogBody:
      "此專案來自您的 OneDrive 網站。OneDrive 中的檔和資料夾是私有的，除非您共用它們。您是否與您的網站成員共用此檔，以便他們可以成功？",
    OneDriveConfirmDialogTitle: "只是檢查...",
    OneDriveEmptyFolderAlt: "空資料夾",
    OneDriveEmptyFolderDescription:
      "要添加檔，請轉到 OneDrive。您還可以使用電腦的 OneDrive 應用將檔添加到此資料夾。",
    ...
    SizeOptionMedium: "中",
    SizeOptionSmall: "小",
    SizeUnit: ["位元組", "K b", "M b", "G b", "結核病", "鉛", "Eb", "等", "Yb"],
    ...
    MyTeamsMessageDontHaveTeams: "你沒有任何團隊",
