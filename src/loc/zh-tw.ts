...
define([], () => {
  ...
  "DynamicFormErrorUpdatingItem": "更新項目時出錯",
  "DynamicFormErrorAddingItem": "添加項目時出錯",
  "DynamicFormErrorReadingIDOfNewItem": "讀取新項目的 ID 時出錯",
  "DynamicFormErrorOnSubmit": "提交表單時出錯",
  "DynamicFormErrorLoadingFieldsInformations": "載入欄位資訊時出錯",
