...
define([], () => {
  return {
    ...
    DynamicFormErrorUpdatingItem: "Error updating item",
    DynamicFormErrorAddingItem: "Error adding new item",
    DynamicFormErrorReadingIDOfNewItem: "Unable to read the ID of the just created folder or Document Set",
    DynamicFormErrorOnSubmit: "Error on submit",
