...
define([], () => {
  return {
    ...
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Idatzi etiketatu nahi duzun terminoa",
    ...
    DynamicFormLoading: "Kargatzen...",
    DynamicFormPleaseWait: "Itxaron mesedez...",
    DynamicFormRequiredErrorMessage: "Ezin duzu hutsik utzi.",
    DynamicFormTermPanelTitle: "Hautatu Epea",
    DynamicFormEnterURLPlaceholder: "Sartu URL bat",
    DynamicFormEnterDescriptionPlaceholder: "Testu alternatiboa",
    DynamicFormDialogValidationErrorTitle: "Balioztatze-errorea",
    DynamicFormDialogValidationErrorMessage:
      "Balidazio-erroreak daude, konpondu aurretik, mesedez.",
    DynamicFormNumberValueMustBeGreaterThan:
      "Balioak {0} baino handiagoa izan behar du",
    DynamicFormNumberValueMustBeBetween:
      "Balioak {0} eta {1} artean egon behar du",
    DynamicFormNumberValueMustBeLowerThan:
      "Balioak {0} baino txikiagoa izan behar du",
  };
});
