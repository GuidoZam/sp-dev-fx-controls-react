  ...
  return {
    ...
    DateTime: {
      ...
      L_RelativeDateTime_XMinutesFuture:
        "{0} minuti jooksul||{0} minuti pärast",
      ...
      L_RelativeDateTime_XDaysFuture:
        "{0} päev alates praegusest||{0} päeva pärast",
    ...
    TaxonomyPickerTermsNotFound:
      "Terminisalvest ei leitud järgmisi valitud termin(id): {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Tõrge faili kustutamisel: {0}, põhjus {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Tõrge laadimisloendi üksuse manuses, põhjus: {0}",
    ListItemAttachmentsconfirmDelete:
      "Kas soovite kindlasti manuse {0} saidi prügikasti saata?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "Fail {0} ole manustatud, põhjus: {1}",
    ...
    CantValidateValidationMessage:
      "Me ei saanud seda linki kontrollida. Palun kontrollige linki ja proovige uuesti.",
    ...
    CopyrightWarning:
      "Te vastutate teiste õiguste, sealhulgas autoriõiguse austamise eest.",
    CreativeCommonsMessage:
      "Need tulemused on kodeeritud Creative Commons litsentsid. Vaadake üle litsentsid, et tagada teie vastavus.",
    ...
    FolderLabelTemplate:
      "{0}, kaust, muudetud {1}, toimetanud {2}, {3} üksused, Privaatne",
    ...
    LinkFileInstructions:
      "Kleebi link faili OneDrive for Business või SharePoint Online",
    LinkHeader: "Lingi kaudu",
    LinkImageInstructions:
      "Kleebi link pildi OneDrive for Business või SharePoint Online",
    ListLayoutAriaLabel: "Saate vaadata suvandeid. {0} {1}.",
    ListLayoutCompact: "Kompaktne vaade",
    ListLayoutCompactDescription:
      "Üksuste ja üksikasjade kuvamine kompaktses loendis",
    ...
    NoExternalLinksValidationMessage:
      "Toetame ainult failide linkimist teie enda organisatsioonis.",
    NoImageValidationMessage:
      "See pole link failitüübile, mida toetame. Saate linkida ainult pildiga.",
    NoRecentFiles: "Hiljutised failid puuduvad",
    NoRecentFilesDescription:
      "Proovige valida oma saidilt mõni fail või laadige see oma seadmest üles.",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, modifitseeritud {2}, mida on toimetanud {3}, {4}, {5}",
    OneDriveConfirmDialogBody:
      "See üksus on teie OneDrive ' i saidilt. OneDrive ' i failid ja kaustad on privaatsed, kui te neid ühiskasutusse ei jaga. Kas jagate seda faili oma saidiliikmetega, et nad saaksid seda teha?",
    OneDriveConfirmDialogTitle: "Lihtsalt kontrollin...",
    OneDriveEmptyFolderAlt: "Tühi kaust",
    OneDriveEmptyFolderDescription:
      "Failide lisamiseks minge oma OneDrive ' i. Samuti saate sellesse kausta faile lisada, kasutades OneDrive ' i rakendust teie arvutile.",
    ...
    SearchResultAriaLabel:
      "Uue vahekaardi pildiallika avamiseks vajutage sisestusklahvi (ENTER).",
    Selected: "Valitud",
    ...
    SizeUnit: ["Baiti", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Nt", "Yb"],
    SorryWebSearch:
      "Kahjuks see funktsioon ei rakendata selles proovis, sest see nõuaks Bing API võti.",
    SortedAscending: "Sorditud A kuni Z",
    SortedDescending: "Sorditud Z-ni",
    TypeAriaLabel:
      "Veergude toimingud failitüübi jaoks, vajutage failitüübi sortimiseks",
    ...
    NewFolderIncorrectSymbolsError:
      'Palun sisestage nimi, mis ei sisalda ühtegi neist märkidest: " * : < > ? /  |.',
    ...
    MyTeamsMessageError:
      "Midagi läks meeskondade laadimisel valesti, proovige hiljem või värskendage brauserit",
    ...
    ListItemCommentDIalogDeleteSubText:
      "Kas soovite kindlasti selle kommentaari kustutada?",
    ...
    MyTeamsMessageDontHaveTeams: "Teil pole ühtegi meeskonda",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Sisestage termin, mille soovite märgistada",
