...
define([], () => {
  ...
  "DynamicFormErrorUpdatingItem": "Грешка при актуализиране на елемент",
  "DynamicFormErrorAddingItem": "Грешка при добавяне на елемент",
  "DynamicFormErrorReadingIDOfNewItem": "Грешка при четене на идентификатора на нов елемент",
  "DynamicFormErrorOnSubmit": "Грешка при изпращане на формуляра",
  "DynamicFormErrorLoadingFieldsInformations": "Грешка при зареждане на информацията за полетата",
