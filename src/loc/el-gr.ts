...
define([], () => {
  ...
  "DynamicFormErrorUpdatingItem": "Σφάλμα κατά την ενημέρωση του στοιχείου",
  "DynamicFormErrorAddingItem": "Σφάλμα κατά την προσθήκη στοιχείου",
  "DynamicFormErrorReadingIDOfNewItem": "Σφάλμα κατά την ανάγνωση του αναγνωριστικού του νέου στοιχείου",
  "DynamicFormErrorOnSubmit": "Σφάλμα κατά την υποβολή της φόρμας",
  "DynamicFormErrorLoadingFieldsInformations": "Σφάλμα κατά την φόρτωση των πληροφοριών πεδίου",
