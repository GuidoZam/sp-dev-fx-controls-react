  ...
  return {
    ...
    DateTime: {
      ...
      L_RelativeDateTime_XDaysFuture:
        "{0} dia a partir de agora| | {0} dias a partir de agora",
    ...
    TaxonomyPickerTermsNotFound:
      "Os próximos termos selecionados não puderam ser encontrados no repositório de termos: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Erro ao excluir arquivo: {0}, motivo {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Erro ao carregar o anexo do item da lista, motivo: {0}",
    ListItemAttachmentsconfirmDelete:
      "Tem certeza de que deseja enviar o anexo {0} para a lixeira do site?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "O arquivo {0} não foi anexado, motivo: {1}",
    ...
    CantValidateValidationMessage:
      "Não foi possível verificar este link. Verifique o link e tente novamente.",
    ...
    CopyrightUrl:
      "https://www.microsoft.com/pt-pt/legal/copyright/default.aspx",
    CopyrightWarning:
      "Você é responsável por respeitar os direitos dos outros, incluindo direitos autorais.",
    CreativeCommonsMessage:
      "Esses resultados são marcados com licenças Creative Commons. Reveja as licenças para garantir sua conformidade.",
    DateFormat: "MM/DD/YYYY hh: mm A",
    DocumentLabelTemplate:
      "{0}, Documento, {1} Modificado, modificado por {2}, Privado",
    ...
    FolderLabelTemplate:
      "{0}, Pasta, {1} Modificado, modificado por {2}, {3} items, Privado",
    ...
    LinkFileInstructions:
      "Cole um link para um arquivo no OneDrive for Business ou no SharePoint Online",
    LinkHeader: "A partir de um link",
    LinkImageInstructions:
      "Cole um link para uma imagem no OneDrive for Business ou no SharePoint Online",
    ...
    NoExternalLinksValidationMessage:
      "Só são suportados links para arquivos da própria organização.",
    NoImageValidationMessage:
      "Este não é um link para um tipo de arquivo suportado. Você só pode usar um link para uma imagem.",
    NoRecentFiles: "Nenhum arquivo recente",
    NoRecentFilesDescription:
      "Tente selecionar um arquivo do seu site ou carregue um do seu dispositivo.",
    NoResultsBadEnglish:
      "Nenhum resultado encontrado. Tente alterar as opções de filtro",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, Modificado {2}, modificado por {3}, {4}, {5}",
    OneDriveConfirmDialogBody:
      "Este item é do seu site OneDrive. Arquivos e pastas no OneDrive são privados, a menos que você os compartilhe. Você compartilhou este arquivo com os membros do seu site para que eles possam aceder?",
    OneDriveConfirmDialogTitle: "Só verificando...",
    OneDriveEmptyFolderAlt: "Pasta vazia",
    OneDriveEmptyFolderDescription:
      "Para adicionar arquivos, aceda ao seu OneDrive. Você também pode adicionar arquivos a esta pasta usando o aplicativo OneDrive para o seu computador.",
    ...
    SearchResultAriaLabel:
      "Pressione Enter para abrir a imagem em uma nova aba.",
    ...
    SorryWebSearch:
      "Desculpe, esta função não está implementada neste exemplo, porque exigiria uma chave de API do Bing.",
    SortedAscending: "Ordenado de A a Z",
    SortedDescending: "Ordenado de Z a A",
    TypeAriaLabel:
      "Operações de coluna para o tipo de arquivo, pressione para classificar no tipo de arquivo",
    ...
    NewFolderIncorrectSymbolsError:
      'Por favor insira um nome que não inclua nenhum destes caracteres: " * : < > ? /  |.',
    ...
    CollectionDataEmptyFields:
      "Não foram fornecidos campos para a coleção de dados.",
    ...
    MyTeamsMessageError:
      "Algo correu mal ao carregar as suas equipas, por favor, tente mais tarde ou atualize o navegador",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Existem erros de validação, corrija-os antes de salvar.",
