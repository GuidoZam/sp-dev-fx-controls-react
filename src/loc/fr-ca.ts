...
define([], () => {
  ...
  "DynamicFormErrorUpdatingItem": "Erreur lors de la mise à jour de l'élément",
  "DynamicFormErrorAddingItem": "Erreur lors de l'ajout d'un élément",
  "DynamicFormErrorReadingIDOfNewItem": "Erreur lors de la lecture de l'ID du nouvel élément",
  "DynamicFormErrorOnSubmit": "Erreur lors de la soumission du formulaire",
  "DynamicFormErrorLoadingFieldsInformations": "Erreur lors du chargement des informations sur les champs",
