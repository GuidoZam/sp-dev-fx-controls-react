...
define([], () => {
  return {
    ...
    OneDriveConfirmDialogBody:
      "此项目来自您的 OneDrive 站点。OneDrive 中的文件和文件夹是私有的，除非您共享它们。您是否与您的网站成员共享此文件，以便他们可以成功？",
    OneDriveConfirmDialogTitle: "只是检查...",
    OneDriveEmptyFolderAlt: "空文件夹",
    OneDriveEmptyFolderDescription:
      "要添加文件，请转到 OneDrive。您还可以使用计算机的 OneDrive 应用将文件添加到此文件夹。",
    ...
    SizeOptionMedium: "中",
    SizeOptionSmall: "小",
    SizeUnit: ["字节", "K b", "M b", "G b", "结核病", "铅", "Eb", "等", "Yb"],
    ...
    MyTeamsMessageDontHaveTeams: "你没有任何团队",
