  ...
  return {
    ...
    DateTime: {
      ...
      L_RelativeDateTime_XDaysFuture:
        "{0} día a partir de ahora {0} días a partir de ahora",
    ...
    TaxonomyPickerTermsNotFound:
      "No se pudieron encontrar los siguientes términos seleccionados en el almacén de términos: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Error en el archivo de eliminación: {0}, razón {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Error en los datos adjuntos del elemento de lista de carga, razón: {0}",
    ListItemAttachmentsconfirmDelete:
      "¿Está seguro de que desea enviar el archivo adjunto {0} a la papelera de reciclaje del sitio?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "El archivo no {0} adjunto, razón: {1}",
    ...
    ListItemAttachmentslPlaceHolderDescription:
      "Por favor, agregue el archivo adjunto",
    ...
    CantValidateValidationMessage:
      "No pudimos verificar este enlace. Compruebe el enlace e inténtelo de nuevo.",
    ...
    CopyrightWarning:
      "Usted es responsable de respetar los derechos de los demás, incluidos los derechos de autor.",
    CreativeCommonsMessage:
      "Estos resultados se etiquetan con licencias Creative Commons. Revise las licencias para asegurarse de que cumple.",
    DateFormat: "MM/DD/AAAA hh:mm A",
    DocumentLabelTemplate:
      "{0}, Documento, {1} modificado, editado por {2}, Privado",
    ...
    FolderLabelTemplate:
      "{0}, Carpeta, {1} modificado, editado por {2}, {3} elementos, Privado",
    ...
    LinkFileInstructions:
      "Pegue un vínculo a un archivo en OneDrive para la Empresa o SharePoint Online",
    LinkHeader: "Desde un enlace",
    LinkImageInstructions:
      "Pegue un vínculo a una imagen en OneDrive para la Empresa o SharePoint Online",
    ListLayoutAriaLabel: "Ver opciones. {0} {1} .",
    ListLayoutCompact: "Vista compacta",
    ListLayoutCompactDescription:
      "Ver elementos y detalles en una lista compacta",
    ...
    NoExternalLinksValidationMessage:
      "Solo admitimos la vinculación a archivos de su propia organización.",
    NoImageValidationMessage:
      "Esto no es un vínculo a un tipo de archivo que admitamos. Solo puede vincular a una imagen.",
    NoRecentFiles: "Sin archivos recientes",
    NoRecentFilesDescription:
      "Intenta seleccionar un archivo de tu sitio o carga uno desde tu dispositivo.",
    NoResultsBadEnglish:
      "No se ha encontrado ningún resultado. Intente cambiar las opciones de filtro",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, {2} modificado, editado por {3}, {4} {5}",
    OneDriveConfirmDialogBody:
      "Este elemento es de su sitio de OneDrive. Los archivos y carpetas de OneDrive son privados a menos que los comparta. ¿Ha compartido este archivo con los miembros de su sitio para que puedan ccess?",
    OneDriveConfirmDialogTitle: "Sólo estoy comprobando...",
    OneDriveEmptyFolderAlt: "Carpeta vacía",
    OneDriveEmptyFolderDescription:
      "Para agregar archivos, vaya a OneDrive. También puede agregar archivos a esta carpeta mediante la aplicación OneDrive para el equipo.",
    ...
    SearchResultAriaLabel:
      "Pulse Intro para abrir la fuente de la imagen en una nueva pestaña.",
    ...
    SizeUnit: ["Bytes", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Eg", "Yb"],
    SorryWebSearch:
      "Lo sentimos, esta función no se implementa en este ejemplo, porque requeriría una clave de Bing API.",
    SortedAscending: "Ordenado de la A a la Z",
    SortedDescending: "Clasificado de Z a A",
    TypeAriaLabel:
      "Operaciones de columna para Tipo de archivo, Pulse para ordenar en Tipo de archivo",
    ...
    NewFolderIncorrectSymbolsError:
      'Introduzca un nombre que no incluya ninguno de estos caracteres: " * : < > ? /  |.',
    ...
    CollectionDataEmptyFields:
      "No se proporcionaron campos para los datos de recopilación.",
    ...
    MyTeamsMessageError:
      "Algo salió mal mientras cargaba sus equipos, por favor, inténtelo más tarde o actualice el navegador",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Hay errores de validación, corríjalos antes de guardar.",
    ...
    MyTeamsMessageDontHaveTeams: "No tienes ningun equipo",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Introduzca un término que desee etiquetar",
