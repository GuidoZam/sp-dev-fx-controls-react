...
define([], () => {
  ...
  "DynamicFormErrorUpdatingItem": "Ett fel uppstod när objektet uppdaterades",
  "DynamicFormErrorAddingItem": "Ett fel uppstod när objektet lades till",
  "DynamicFormErrorReadingIDOfNewItem": "Ett fel uppstod när ID för det nya objektet lästes",
  "DynamicFormErrorOnSubmit": "Ett fel uppstod när formuläret skickades",
  "DynamicFormErrorLoadingFieldsInformations": "Ett fel uppstod när fältinformationen lästes in",
