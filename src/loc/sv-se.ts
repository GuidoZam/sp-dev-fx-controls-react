...
define([], () => {
  return {
    ...
    TaxonomyPickerTermsNotFound:
      "Det gick inte att hitta nästa valda term i termarkivet: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Fel vid radering av fil: {0}, orsak {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Fel vid laddning av bilaga, orsak: {0}",
    ListItemAttachmentsconfirmDelete:
      "Vill du verkligen flytta bilagan {0} till papperskorgen?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "Filen {0} kunde inte bifogas, orsak: {1}",
    ...
    CantValidateValidationMessage:
      "Vi kunde inte verifiera den här länken. Vänligen kontrollera länken och försök igen.",
    ...
    CopyrightWarning:
      "Du är ansvarig för att respektera andras rättigheter, inklusive upphovsrätt.",
    CreativeCommonsMessage:
      "Dessa resultat är märkta med Creative Commons-licenser. Granska licenserna för att säkerställa att du följer dem.",
    DateFormat: "ÅÅÅÅ-MM-DD HH: mm A",
    DocumentLabelTemplate:
      "{0}, dokument, ändrad {1}, redigerad av {2}, privat",
    ...
    FolderLabelTemplate:
      "{0}, mapp, ändrad {1}, redigerad av {2}, {3} objekt, privat",
    ...
    LinkFileInstructions:
      "Klistra in en länk till en fil i OneDrive för företag eller SharePoint Online",
    LinkHeader: "Från en länk",
    LinkImageInstructions:
      "Klistra in en länk till en bild i OneDrive för företag eller SharePoint Online",
    ListLayoutAriaLabel: "Visa alternativ. {0} {1}.",
    ListLayoutCompact: "Kompakt lista",
    ListLayoutCompactDescription:
      "Visa objekt och information i en kompakt lista",
    ...
    ListLayoutTileDescription:
      "Visa förhandsgranskningar av objekt sida vid sida",
    ...
    NoExternalLinksValidationMessage:
      "Vi stöder bara länkning till filer i din egen organisation.",
    NoImageValidationMessage:
      "Detta är inte en länk till en filtyp som stöds. Du kan endast länka till en bild.",
    NoRecentFiles: "Inga senaste filer",
    NoRecentFilesDescription:
      "Prova att välja en fil från din webbplats eller ladda upp en från din enhet.",
    NoResultsBadEnglish:
      "Det finns inget resultat hittades. Försök att ändra filteralternativen",
    ...
    OneDriveConfirmDialogBody:
      "Det här objektet är från din OneDrive-webbplats. Filer och mappar på OneDrive är privata om du inte delar dem. Har du delat denna fil med dina webbplatsmedlemmar så att de kan komma åt dem?",
    OneDriveConfirmDialogTitle: "Kontrollerar...",
    OneDriveEmptyFolderAlt: "Tom mapp",
    OneDriveEmptyFolderDescription:
      "Om du vill lägga till filer går du till OneDrive. Du kan också lägga till filer i den här mappen med hjälp av OneDrive-appen för datorn.",
    ...
    OrgAssetsTabLabel:
      "Bilder och filer som tillhandahålls av din organisation",
    ...
    SearchResultAriaLabel:
      "Tryck på RETUR för att öppna bildkällan i en ny flik.",
    Selected: "Markerade",
    SharingField: "Dela",
    ...
    SorryWebSearch:
      "Den här funktionen implementeras inte i det här exemplet eftersom den kräver en API-nyckel för Bing.",
    SortedAscending: "Sortera stigande A till Ö",
    SortedDescending: "Sortera fallande Ö till A",
    TypeAriaLabel:
      "Kolumn åtgärder för filtyp, tryck för att sortera efter filtyp",
    ...
    NewFolderIncorrectSymbolsError:
      'Ange ett namn som inte innehåller något av följande tecken: " * : < > ? /  |.',
    ...
    MyTeamsMessageError:
      "Något gick fel när dina teams lästes in, försök senare eller uppdatera webbläsaren",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Det finns valideringsfel, åtgärda dem innan du sparar.",
