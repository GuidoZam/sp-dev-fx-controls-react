...
define([], () => {
  return {
    ...
    TaxonomyPickerTermsNotFound:
      "Die nächsten ausgewählten Begriffe konnten im Terminologiespeicher nicht gefunden werden: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Fehler beim Löschen der Datei: {0}, Grund: {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Fehler beim Laden der Anhänge, Grund: {0}",
    ListItemAttachmentsconfirmDelete:
      "Sind Sie sich sicher, dass Sie die Anlage {0} in den Papierkorb der Website verschieben möchten?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "Die Datei {0} wurde nicht hinzugefügt, Grund: {1}",
    ...
    CantValidateValidationMessage:
      "Wir konnten diesen Link nicht überprüfen. Überprüfen Sie den Link, und versuchen Sie es erneut.",
    ...
    CopyrightWarning:
      "Sie sind für die Achtung der Rechte anderer verantwortlich, einschließlich des Urheberrechts.",
    CreativeCommonsMessage:
      "Diese Ergebnisse sind mit Creative Commons-Lizenzen gekennzeichnet. Überprüfen Sie die Lizenzen, um sicherzustellen, dass Sie die Anforderungen erfüllen.",
    DateFormat: "MM/DD/YYYY hh:mm A",
    DocumentLabelTemplate:
      "{0}, Dokument, Geändertes {1}, bearbeitet von {2}, Privat",
    ...
    FolderLabelTemplate:
      "{0}, Ordner, geänderte {1}, bearbeitet von {2}, {3} Elementen, Privat",
    ...
    LinkFileInstructions:
      "Einfügen eines Links zu einer Datei in OneDrive for Business oder SharePoint Online",
    LinkHeader: "Von einem Link",
    LinkImageInstructions:
      "Einfügen eines Links zu einem Bild in OneDrive for Business oder SharePoint Online",
    ListLayoutAriaLabel: "Optionen anzeigen. {0} {1} .",
    ListLayoutCompact: "Kompakte Ansicht",
    ListLayoutCompactDescription:
      "Anzeigen von Elementen und Details in einer kompakten Liste",
    ListLayoutList: "Listenansicht",
    ListLayoutListDescrition:
      "Anzeigen von Elementen und Details in einer Liste",
    ...
    NoExternalLinksValidationMessage:
      "Wir unterstützen nur die Verknüpfung mit Dateien in Ihrer eigenen Organisation.",
    NoImageValidationMessage:
      "Dies ist kein Link zu einem Dateityp, den wir unterstützen. Sie können nur eine Verknüpfung zu einem Bild herstellen.",
    NoRecentFiles: "Keine aktuellen Dateien",
    NoRecentFilesDescription:
      "Versuchen Sie, eine Datei von Ihrer Website auszuwählen, oder laden Sie eine Datei von Ihrem Gerät hoch.",
    NoResultsBadEnglish:
      "Es wurde kein Ergebnis gefunden. Versuchen Sie, die Filteroptionen zu ändern",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, Modified {2}, bearbeitet von {3}, {4}, {5}",
    OneDriveConfirmDialogBody:
      "Dieses Element stammt von Ihrer OneDrive-Website. Dateien und Ordner in OneDrive sind privat, es sei denn, Sie geben sie aus. Haben Sie diese Datei für Ihre Websitemitglieder freigegeben, damit sie sie zissen können?",
    OneDriveConfirmDialogTitle: "Nur überprüfen...",
    OneDriveEmptyFolderAlt: "Leerer Ordner",
    OneDriveEmptyFolderDescription:
      "Um Dateien hinzuzufügen, wechseln Sie zu OneDrive. Sie können diesem Ordner auch Dateien hinzufügen, indem Sie die OneDrive-App für Ihren Computer verwenden.",
    ...
    OrgAssetsTabLabel:
      "Bilder und Dateien, die von Ihrer Organisation bereitgestellt werden",
    ...
    SearchResultAriaLabel:
      "Drücken Sie die Eingabetaste, um die Bildquelle in einer neuen Registerkarte zu öffnen.",
    ...
    SorryWebSearch:
      "Diese Funktion ist in diesem Beispiel leider nicht implementiert, da dafür ein Bing-API-Schlüssel erforderlich wäre.",
    SortedAscending: "Sortiert A bis Z",
    SortedDescending: "Sortiert Z nach A",
    TypeAriaLabel:
      "Spaltenoperationen für Dateityp, Drücken, um nach Dateityp zu sortieren",
    ...
    NewFolderIncorrectSymbolsError:
      'Bitte geben Sie einen Namen ein, der keines dieser Zeichen enthält: " * : < > ? /  |.',
    ...
    CollectionDataEmptyFields:
      "Für die Erfassungsdaten wurden keine Felder bereitgestellt.",
    ...
    MyTeamsMessageError:
      "Beim Laden Ihrer Teams ist etwas schief gelaufen, bitte versuchen Sie es später oder aktualisieren Sie den Browser",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Es liegen Validierungsfehler vor. Bitte beheben Sie diese vor dem Speichern.",
    ...
    DynamicFormNumberValueMustBeLowerThan:
      "Der Wert muss niedriger als {0} sein.",
    ...
    ListItemCommentsNoCommentsLabel: "Keine Kommentare",
    OrgAssetsLinkLabel: "Ihre Organisation",
    MyTeamsMessageDontHaveTeams: "Sie haben keine Teams",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Geben Sie einen Begriff ein, den Sie markieren möchten",
    ModernTaxonomyPickerTreeTitleSingle: "Wählen Sie ein Tag aus",
    ModernTaxonomyPickerTreeTitleMulti:
      "Wählen Sie einen oder mehrere Tags aus",
