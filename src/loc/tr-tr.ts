...
define([], () => {
  return {
    ...
    TaxonomyPickerTermsNotFound:
      "Bir sonraki seçili terimler terim deposunda bulunamadı: {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Silme dosyasındaki hata: {0}, neden {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Yük listesi madde ekinde hata, neden: {0}",
    ListItemAttachmentsconfirmDelete:
      "Eki {0} site geri dönüşüm kutusuna göndermek istediğinizden emin misiniz?",
    ...
    CantValidateValidationMessage:
      "Bu bağlantıyı doğrulayamadık. Lütfen bağlantıyı kontrol edin ve yeniden deneyin.",
    ...
    CopyrightWarning:
      "Telif hakkı da dahil olmak üzere başkalarının haklarına saygı göstermeksizin sorumlusunuz.",
    CreativeCommonsMessage:
      "Bu sonuçlar Creative Commons lisansları ile etiketlenir. Uymanızı sağlamak için lisansları gözden geçirin.",
    ...
    FolderLabelTemplate:
      "{0}, Klasör, Modifiye {1}, {2}, {3} öğeleri, Özel tarafından düzenlenen",
    ...
    LinkFileInstructions:
      "OneDrive for Business veya SharePoint Online'da bir dosyaya bağlantı yapıştır",
    LinkHeader: "Bir bağlantıdan",
    LinkImageInstructions:
      "OneDrive for Business veya SharePoint Online'daki bir resme bağlantı yapıştır",
    ListLayoutAriaLabel: "Seçenekleri görüntüleyin. {0} {1} .",
    ListLayoutCompact: "Kompakt görünüm",
    ListLayoutCompactDescription:
      "Öğeleri ve ayrıntıları kompakt bir listede görüntüleme",
    ...
    NoExternalLinksValidationMessage:
      "Yalnızca kendi kuruluşunuzdaki dosyalara bağlantı etmeyi destekliyoruz.",
    NoImageValidationMessage:
      "Bu, desteklediğimiz bir dosya türüne bağlantı değildir. Yalnızca bir resme bağlantı kurabilirsiniz.",
    NoRecentFiles: "Son dosya yok",
    NoRecentFilesDescription:
      "Sitenizden bir dosya seçmeyi deneyin veya cihazınızdan bir dosya yükleyin.",
    NoResultsBadEnglish:
      "Sonuç bulunamadı. Filtre seçeneklerini değiştirmeyi deneyin",
    ...
    ODRowArialLabelTemplate:
      "{0}, {1}, Modifiye {2}, {3}, {4}, {5} tarafından düzenlendi",
    OneDriveConfirmDialogBody:
      "Bu öğe OneDrive sitenizden dir. OneDrive'daki dosya ve klasörler siz paylaşmadığınız sürece özeldir. Bu dosyayı site üyelerinizle paylaştınız mı?",
    OneDriveConfirmDialogTitle: "Sadece kontrol ...",
    OneDriveEmptyFolderAlt: "Boş klasör",
    OneDriveEmptyFolderDescription:
      "Dosya eklemek için OneDrive'ınıza gidin. Ayrıca, bilgisayarınız için OneDrive uygulamasını kullanarak bu klasöre dosya ekleyebilirsiniz.",
    ...
    SizeUnit: ["Bayt", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Örneğin", "Yb"],
    SorryWebSearch:
      "Üzgünüz, bu işlev bu örnekte uygulanmaz, çünkü bir Bing API anahtarı gerektirir.",
    SortedAscending: "A'dan Z'ye Sıralanmış",
    SortedDescending: "Z'yi A'ya sıraladı",
    TypeAriaLabel:
      "Dosya türü için sütun işlemleri, Dosya türünde sıralamak için basın",
    ...
    NewFolderIncorrectSymbolsError:
      'Lütfen bu karakterlerin hiçbirini içermeyen bir ad girin: " * : < > ? /  |.',
    ...
    MyTeamsMessageError:
      "Ekiplerinizi yüklerken bir şeyler ters gitti, lütfen daha sonra deneyin veya tarayıcıyı yenileyin",
    ...
    DynamicFormDialogValidationErrorMessage:
      "Doğrulama hataları var, lütfen kaydetmeden önce düzeltin.",
    ...
    DynamicFormNumberValueMustBeLowerThan:
      "Değer, {0} değerinden düşük olmalıdır",
    ...
    MyTeamsMessageDontHaveTeams: "Takımın yok",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Etiketlemek istediğiniz bir terim girin",
