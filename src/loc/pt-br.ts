  ...
  return {
    ...
    DateTime: {
      ...
      L_RelativeDateTime_XDaysFuture:
        "{0} dias a partir de agora || {0} dias a partir de agora",
    ...
    TaxonomyPickerTermsNotFound:
      "Os próximos termos selecionados não foram encontrados no repositório de termos: {0}",
    ...
    CopyrightUrl:
      "https://www.microsoft.com/pt-br/legal/copyright/default.aspx",
    CopyrightWarning:
    ...
    DocumentLabelTemplate:
      "{0}, Documento, Modificado {1}, editado por {2}, Privado",
    ...
    FolderLabelTemplate:
      "{0}, Pasta, Modificado {1}, editado por {2}, {3} items, Privado",
    ...
    LinkFileInstructions:
      "Cole um link para um arquivo no OneDrive for Business ou SharePoint Online",
    ...
    OneDriveConfirmDialogBody:
      "Este item é do seu site OneDrive. Arquivos e pastas no OneDrive são privados, a menos que você os compartilhe. Você compartilhou este arquivo com os membros do seu site para que eles possam acessá-lo?",
    ...
    TypeAriaLabel:
      "Operações de coluna para o tipo de arquivo, pressione para classificar por tipo de arquivo",
