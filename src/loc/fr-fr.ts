...
define([], () => {
  return {
    ...
    DateTime: {
      ...
      L_RelativeDateTime_XDaysFuture:
        "{0} jour à partir de maintenant || {0} jours à partir de maintenant",
    ...
    TaxonomyPickerTermsNotFound:
      "Le ou les termes sélectionnés suivants n’ont pas pu être trouvés dans le magasin de termes : {0}",
    TaxonomyPickerInvalidTerms:
      "Veuillez corriger le(s) terme(s) non valide(s) : {0}",
    ...
    ListItemAttachmentsfileDeleteError:
      "Erreur lors de la suppression du fichier : {0}, cause : {1}",
    ListItemAttachmentserrorLoadAttachments:
      "Erreur lors du chargement de la pièce jointe, cause : {0}",
    ListItemAttachmentsconfirmDelete:
      "Voulez-vous vraiment envoyer la pièce jointe {0} à la Corbeille du site ?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "Le fichier {0} n'a pas pu être ajouté en tant que pièce jointe, cause : {1}",
    ...
    CantValidateValidationMessage:
      "Nous n'avons pas pu vérifier ce lien. S'il vous plaît vérifier le lien et essayer à nouveau.",
    ...
    CopyrightUrl:
      "https://www.microsoft.com/fr-FR/legal/copyright/default.aspx",
    CopyrightWarning:
      "Vous êtes responsable du respect des droits d'autrui, y compris du droit d'auteur.",
    CreativeCommonsMessage:
      "Ces résultats sont étiquetés avec des licences Creative Commons. Passez en revue les licences pour vous assurer de votre conformité.",
    ...
    FolderIconUrl:
      "https://spoprod-a.akamaihd.net/files/odsp-next-prod_2019-01-11_20190116.001/odsp-media/images/itemtypes/20/folder.svg",
    FolderLabelTemplate:
      "{0}, Dossier, Modifié le {1}, édité par {2}, {3} éléments, Privé",
    ...
    LinkFileInstructions:
      "Coller un lien provenant de OneDrive Entreprise ou SharePoint Online",
    LinkHeader: "À partir d'un lien",
    LinkImageInstructions:
      "Coller le lien d'une image provenant de OneDrive Entreprise ou SharePoint Online",
    ListLayoutAriaLabel: "Afficher les options. {0} {1} .",
    ListLayoutCompact: "Vue compacte",
    ListLayoutCompactDescription:
      "Afficher les éléments et les détails dans une liste compacte",
    ListLayoutList: "Affichage en liste",
    ListLayoutListDescrition:
      "Afficher les éléments et les détails dans une liste",
    ListLayoutTile: "Affichage en mosaïque",
    ListLayoutTileDescription:
      "Afficher les éléments avec des aperçus en mosaïque",
    ...
    NoExternalLinksValidationMessage:
      "Nous prenons en charge uniquement les liens vers des fichiers de votre organisation (tenant).",
    NoImageValidationMessage:
      "Ce n'est pas un lien vers un type de fichier que nous prenons en charge. Vous pouvez uniquement créer un lien vers une image.",
    NoRecentFiles: "Aucun fichier récent",
    NoRecentFilesDescription:
      "Essayez de sélectionner un fichier sur votre site ou téléchargez-en un depuis votre appareil.",
    NoResultsBadEnglish:
      "*** Aucun résultat n'a été trouvé. Essayez de changer les options de filtre",
    ...
    OneDriveConfirmDialogBody:
      "Cet élément provient de votre OneDrive. Les fichiers et dossiers dans OneDrive sont privés, sauf si vous les partagez. Avez-vous partagé ce fichier avec les membres de votre site afin qu'ils puissent y accéder ?",
    OneDriveConfirmDialogTitle: "Nous vérifions ...",
    OneDriveEmptyFolderAlt: "Dossier vide",
    OneDriveEmptyFolderDescription:
      "Pour ajouter des fichiers, accédez à votre OneDrive. Vous pouvez également ajouter des fichiers à ce dossier à l'aide de l'application OneDrive de votre ordinateur.",
    ...
    OrgAssetsTabLabel:
      "Images et fichiers fournis par votre organisation (tenant)",
    ...
    SearchResultAriaLabel:
      "Appuyez sur entrée pour ouvrir l'image dans un nouvel onglet.",
    ...
    SizeUnit: ["Octets", "Ko", "Mo", "Go", "To", "Po", "Eo", "Zo", "Yo"],
    SorryWebSearch:
      "Désolé, cette fonction n'est pas implémentée dans cet exemple, car elle nécessiterait une clé d'API Bing.",
    SortedAscending: "Trié de A à Z",
    SortedDescending: "Tri de Z à A",
    TypeAriaLabel:
      'Opérations sur les colonnes "Type de fichier", sélectionné pour trier "Type de fichier"',
    ...
    NewFolderIncorrectSymbolsError:
      'Veuillez saisir un nom qui n’inclut aucun de ces caractères : " * : < > ? /  |.',
    ...
    CollectionDataEmptyFields:
      "Aucun champ n’a été fourni pour les données de collecte.",
    ...
    MyTeamsMessageError:
      "Quelque chose s’est mal passé lors du chargement de vos équipes, veuillez essayer plus tard ou actualiser le navigateur",
    ...
    DynamicFormRequiredErrorMessage:
    ...
    DynamicFormDialogValidationErrorMessage:
      "Il y a des erreurs de validation, veuillez les corriger avant d'enregistrer.",
    ...
    MyTeamsMessageDontHaveTeams: "Vous n'avez pas d'équipes",
    ModernTaxonomyPickerDefaultPlaceHolder:
      "Entrez un terme que vous souhaitez marquer",
