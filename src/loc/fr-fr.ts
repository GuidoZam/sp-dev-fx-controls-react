...
define([], () => {
  ...
  "DynamicFormErrorAddingItem": "Erreur lors de l'ajout de l'élément",
  ...
  "DynamicFormErrorLoadingFieldsInformations": "Erreur lors du chargement des informations de champs",
